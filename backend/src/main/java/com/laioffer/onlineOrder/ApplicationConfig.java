...
@Configuration
@EnableWebMvc       // to create classes which are used in SpringMVC
...
public class ApplicationConfig {
    ...
    public DataSource dataSource() {
        String RDS_ENDPOINT = "laiproject-instance.cw4tujw0qa1q.us-east-2.rds.amazonaws.com";
        String USERNAME = "admin";
        String PASSWORD = "XieXuhan23.";
